...
public class Lab604 {
	...
	public static void inputStudent() {
		do {
			...
			subId =subjectId+ ""; //convert subjectID from interger to string 
			
		}while(!isLength(studentId,subId));
		System.out.println();
		displayData(isITStudent(studentId),isITStuject(subId));
	}//end of inputStudent()
	...
	public static boolean isITStuject(String sudId) {
	...
	public static void displayData(boolean stdIT,boolean subIT) {
		...
		if(subIT==true) {
			...
			System.out.println("not enroll in course for Year1");
		}	
	}//end of displayData()
